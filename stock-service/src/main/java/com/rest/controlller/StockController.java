...
public class StockController {
	...
	public List<Quote> getStock(@PathVariable("username") final String username){
		...
		ResponseEntity<List<String>> quoteResponse = restTemplate.exchange("http://dbService/rest/db/"+username, HttpMethod.GET,null,new ParameterizedTypeReference<List<String>>() {
